file://<WORKSPACE>/src/main/java/com/flipkart/business/SlotServiceInterface.java
...
action parameters:
uri: file://<WORKSPACE>/src/main/java/com/flipkart/business/SlotServiceInterface.java
text:
```scala
